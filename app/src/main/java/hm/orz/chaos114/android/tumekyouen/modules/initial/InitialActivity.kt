...
class InitialActivity : DaggerAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tumeKyouenRepository.selectMaxStageNo()
                ...
                .`as`<SingleSubscribeProxy<Int>>(AutoDispose.autoDisposable(AndroidLifecycleScopeProvider.from(this)))
                .subscribe({ stageNo ->
                    // has stages in db
                    goNextActivity()
                },
